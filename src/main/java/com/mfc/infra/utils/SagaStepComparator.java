...
public class SagaStepComparator implements Comparator<Object> {
    ...
    public int compare(final Object data1, final Object data2) {
        ...
        int retorno = 0;
        if (event1.getSagaStepInfo().getStepNumber() > event2.getSagaStepInfo().getStepNumber()) {
            retorno = -1;
        } else if (event1.getSagaStepInfo().getStepNumber() < event2.getSagaStepInfo().getStepNumber()) {
            retorno = 1;
        }
        return retorno;
    }
