...
import com.arch.mfc.backendA.domain.model.query.CustomerOrderDocument;
...
@Service
public class CustomerOrderQueryServiceConsumerAdapter extends QueryInputConsumerAdapter<com.arch.mfc.backend.micro.customers.domain.model.query.CustomerOrderDocument> {
