...
public class CustomerArqArqRelationalStepArqSagaAdapterService extends ArqArqRelationalServiceStepArqSagaAdapter<Customer, CustomerDTO, Long> {
    ...
    @Autowired
    public CustomerArqArqRelationalStepArqSagaAdapterService(CustomerCommandRepositoryPort customerCommandRepositoryPortP) {
