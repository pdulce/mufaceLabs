...
public class RegaloStepArqSagaAdapterServiceArqArq extends ArqArqRelationalServiceStepArqSagaAdapter<Regalo, RegaloDTO, Long> {
    ...
    @Autowired
    public RegaloStepArqSagaAdapterServiceArqArq(RegaloCommandRepository regaloCommandRepository) {
