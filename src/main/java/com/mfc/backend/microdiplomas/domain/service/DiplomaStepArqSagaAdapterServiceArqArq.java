...
import com.mfc.infra.output.adapter.ArqArqRelationalServiceStepArqSagaAdapter;
...
public class DiplomaStepArqSagaAdapterServiceArqArq extends ArqArqRelationalServiceStepArqSagaAdapter<Diploma, DiplomaDTOArq, Long> {
    ...
    @Autowired
    public DiplomaStepArqSagaAdapterServiceArqArq(DiplomaCommandRepository dplomaCommandRepository) {
    ...
    public Object doSagaOperation(ArqEvent event) throws Throwable {
        ...
        return this.crear(ArqDTOConverter.convertToDTO(diploma, DiplomaDTOArq.class));
    }
    ...
    public Object doSagaCompensation(ArqEvent event) {
        ...
        this.borrar(ArqDTOConverter.convertToDTO(diploma, DiplomaDTOArq.class));
        return diploma;
    }
